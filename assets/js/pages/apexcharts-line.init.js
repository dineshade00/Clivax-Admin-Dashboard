...
linechartBasicColors &&
  ((options = {
    ...
    grid: {
      row: { colors: ["#eff2f7", "transparent"], opacity: 0.5 },
      borderColor: "#000",
    },
...
linechartDatalabelColors &&
  ((options = {
    ...
    series: [
      { name: "Active", data: [21, 24, 12, 13, 22, 11, 13, 12, 22, 9, 8, 7] },
      {
        name: "Inactive",
        data: [14, 11, 16, 12, 17, 13, 12, 11, 15, 22, 17, 11],
      },
    ],
    title: {
    ...
    yaxis: { title: { text: "Active & Inactive" }, min: 5, max: 40 },
    legend: {
      position: "top",
